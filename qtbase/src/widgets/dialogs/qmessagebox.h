...
str)).arg(QString::fromLatin1(qVersion())); QMessageBox::critical(nullptr, QApplication::tr(\
"Incompatible Qt Library Error"), s, QMessageBox::Abort, QMessageBox::NoButton); qFatal("%s", s.toLatin1().data()); }}
